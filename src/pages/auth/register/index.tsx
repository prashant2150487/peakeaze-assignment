        ...
        <Grid container component="main" sx={{ height: '100vh', backgroundColor: '#F8F9FA' }}>
            ...
            >
                ...
                <Box sx={{ zIndex: 1, mt: -10 }}>
                    <Typography variant="h3" fontWeight="bold" sx={{ mb: 1, lineHeight: 1.2 }}>Join the future of</Typography>
                    <Typography variant="h3" fontWeight="bold" sx={{ color: 'rgba(255,255,255,0.7)', mb: 3, lineHeight: 1.2 }}>automated accounting.</Typography>
                    <Typography variant="body1" sx={{ maxWidth: 450, color: 'rgba(255,255,255,0.8)', lineHeight: 1.6 }}>
                        Create your account and start managing your invoices with AI-powered intelligence.
                    </Typography>
                </Box>
                ...
                <Box sx={{ display: 'flex', gap: 6, zIndex: 1, pt: 4, borderTop: '1px solid rgba(255,255,255,0.1)' }}>
                    <Box>
                        ...
                        <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.7)', display: 'block' }}>Efficiency</Typography>
                    </Box>
                    <Box>
                        <Typography variant="h5" fontWeight="bold">24/7</Typography>
                        <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.7)', display: 'block' }}>Automation</Typography>
                    </Box>
                </Box>
            </Grid>
            ...
            <Grid item xs={12} sm={8} md={6} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                <Box sx={{ width: '100%', maxWidth: 400, px: 3 }}>
                    <Box sx={{ textAlign: 'center', mb: 4 }}>
                        <Typography variant="h4" fontWeight="bold" sx={{ mb: 1, color: '#1a1a1a' }}>Create account</Typography>
                        <Typography variant="body2" sx={{ color: '#666' }}>Get started with your 14-day free trial.</Typography>
                    </Box>
                    ...
                    <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
                        ...
                        <TextField
                            ...
                            sx={{ mb: 2, '& .MuiOutlinedInput-root': { borderRadius: 2, backgroundColor: '#fff' } }}
                            InputProps={{
                                startAdornment: (
                        ...
                        <Typography variant="body2" sx={{ fontWeight: 600, mb: 0.5, color: '#333' }}>Account Role</Typography>
                        <TextField
                            select
                            fullWidth
                            value={role}
                        ...
                        <Typography variant="body2" sx={{ fontWeight: 600, mb: 0.5, color: '#333' }}>Password</Typography>
                        <TextField
                            margin="normal"
                            required
                            fullWidth
